...
And by adding a little pimp and labels with `geom_sankey_label` which places labels in the center of nodes if given the same aestethics. `ggsunkey` also comes with custom minimalistic themes that can be used.
